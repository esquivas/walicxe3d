...
module parameters
  ...
  real, parameter :: xphystot = 50.0 * 1.98 * RJUP !< Physical domain size along x
  real, parameter :: yphystot = 12.5 * 1.98 * RJUP !< Physical domain size along y
  real, parameter :: zphystot = 50.0 * 1.98 * RJUP !< Physical domain size along z
